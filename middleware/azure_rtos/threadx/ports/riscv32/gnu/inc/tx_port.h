...
#else
extern int __get_interrupt_state(void);
extern void __set_interrupt_state(int);
extern void __disable_interrupt(void);
#define TX_INTERRUPT_SAVE_AREA                  int interrupt_save;
...
CHAR                            _tx_version_id[] =
                                    "Copyright (c) Microsoft Corporation. All rights reserved.  *  ThreadX RISC-V32/IAR Version G6.2.1 *";
#else
